...
class PermissionModalResource extends Component
{
    ...
    protected $listeners = [
        'change_permission_type' => 'change_permission_type',
        'change_permission_menu_id' => 'change_permission_menu_id',
    ...
    {
        return view('livewire.simonis.authorization.permission-modal-resource');
    }
}
