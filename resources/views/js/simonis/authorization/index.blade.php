    ...
    $(document).ready(function () {
        ...
        @can('[Manajemen Sistem] Hak Akses - Melihat Izin')
            ...
            var permission_table = $('#permission_table').DataTable({
                ...
                "serverSide": true,
                "ordering": false,
                "ajax": "{{ route('Table | Simonis | Authorization | Permission') }}",
                lengthMenu: [
                    [5, 10, 25, 100, -1],
                    [5, 10, 25, 100, "All"]
                ],
                ...
                dom: '<"row px-4"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"{{ (Auth::user()->can("[Manajemen Sistem] Hak Akses - Menambah Izin") ? 'B' : '') }}>>t<"row"<"col-sm-12 col-md-12 d-flex justify-content-center"i>><"row"<"col-sm-12 col-md-12 d-flex justify-content-center"p>>',
                buttons: [{
            ...
            permission_table.columns().every(function () {
                var table = this;
